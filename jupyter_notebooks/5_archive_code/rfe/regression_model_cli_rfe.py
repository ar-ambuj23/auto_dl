...
def get_best_model(csv_name,label_col,num_features):
    ...
    return best_model, output_df #add trials
...
def display_results(best_model,output_df,label_col):    
    ...
    print("Validation Size: {} rows".format(x_valid.shape[0])) #new
    print("Testing Size: {} rows".format(x_test.shape[0]))
    loss_val,rmse_val = best_model.evaluate(x_valid,y_valid,verbose=0) #new
    print("RMSE on the valid data: ",loss_val**0.5) #new
