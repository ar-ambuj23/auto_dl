...
def update_config_db(csv_name,label_col,selected_cols,accuracy,model_type):
    ...
    try:
        ...
        pass
    insert_query = "INSERT INTO config_table (model_name, model_type,list_of_features,target_column,accuracy) VALUES (%s, %s, %s, %s, %s)"
    values = (csv_name,model_type,str(selected_cols),label_col,accuracy)
